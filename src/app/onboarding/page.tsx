        ...
        <>
            <div className="h-[100dvh] w-full flex flex-col items-center justify-center py-5 px-4 gap-20">
                <div className="flex flex-col items-center">
                    ...
                    <h1 className="mt-10 text-left w-full pl-4 text-2xl font-extrabold">Welcome to DataCrew!</h1>
                    <p className="mt-2 text-justify text-gray-400 pl-4 pr-4">A data-to-earn platform emporing you to earn rewards by contributing data.</p>
                </div>
                <WalletMultiButton />
            </div>
        </>
